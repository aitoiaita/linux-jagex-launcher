...
use oauth2::{CsrfToken, ResponseType, Scope, RedirectUrl};
use rand::{thread_rng, Rng};
use serde::{Serialize, Deserialize};
use url::Url;

use crate::{xdg::{XDGCredsState, XDGCredsStateError}, trans_tuple_struct};

use super::{jagex_oauth::JagexClient, launcher_client::{LAUNCHER_AUTH_URL, LAUNCHER_TOKEN_URL}, load_oauth_client};
